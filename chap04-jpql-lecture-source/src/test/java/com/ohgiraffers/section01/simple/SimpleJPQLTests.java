...
public class SimpleJPQLTests {
     ...
     *  4. 엔티티 별칭을 필수로 사용해야 하며 별칭 없이 작성하면 에러가 발생한다. (버전이 올라가면서 에러 발생안나게 됨)
     *  + 다중행을 조회할 땐 별칭을 필수로 사용해야한다!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     *  -
     *  jpql의 사용 방법
     ...
     *                      지정한 타입이 반환된다.
     *      2-2 Query : 반환할 타입을 명확하게 지정할 수 없을 때 사용하며 쿼리 객체 메소드의 실행 결과로
     *                  Object[]이 반환된다.
    ...
    * */
    ...
    @Test
    public void distinct를_활용한_종벅제거_여러_행_조회_테스트() {

        /* 설명. 메뉴로 존재하는 카테고리의 종류만 중복을 제거하고 조회 */
