...
public class ProblemOfUsingDirectSQLTests { // SQL을 직접 썼을때 사용하는 문제들
     ...
     *  2. SQL에 의존하여 개발해야한다.
     *  3. 패러다임 불일치(자바의 상속, 자바의 연관관계, 객체 그래프 탐색, 방향성 등)
     *  4. 동일성 보장 문제
    * */
    ...
    // 설명. 3. 패러다임 불일치(자바의 상속, 자바의 연관관계, 객체 그래프 탐색, 방향성 등)
    /* 설명. 3-1. 상속 문제
     *  객체 지향 언어의 상속 개념과 유사한 것이 데이터베이스의 서브타입엔터티이다. ( 서브타입을 별도의 클래스로 나뉘었을 때 )
    ...
    * */
    /* 설명. 3-2. 연관관계 문제, 객체 그래프 탐색 문제
     *  (객체지향에서 말하는) 가지고 있는 연관관계(ASSOCIATION 연관관계 혹은 COLLECTION 연관관계) 경우 데이터베이스 저장 구조와 다른 형태이다.
     *   -
     *  public class Menu {
    ...
    void testEquals() throws SQLException {
        ...
        // then
        Assertions.assertNotEquals(menu1, menu2);      // 필기. 주소값이 같냐~ ,초록불이 나오면 다르다는 뜻
    }
